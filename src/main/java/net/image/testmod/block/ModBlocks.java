package net.image.testmod.block;

import net.image.testmod.TestMod;
import net.image.testmod.block.custom.SpeedyBlock;
import net.image.testmod.item.ModCreativeModeTab;
import net.image.testmod.item.ModItems;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BLOSSOM_BLOCK = registerBlock("blossom_block",
            () -> new Block(BlockBehaviour.Properties.of(Material.METAL)
                    .strength(5f).requiresCorrectToolForDrops()), ModCreativeModeTab.COURSE_TAB);
